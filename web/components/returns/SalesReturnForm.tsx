...
import { salesReturnSchema } from '@seed/schemas';
...
export default function SalesReturnForm() {
  ...
  const createMutation = clientTrpc.returns.createSalesReturn.useMutation({
    onSuccess: () => {
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Linked Invoice (optional)</FormLabel>
                  <FormControl>
                    <Input
