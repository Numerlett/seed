...
import { purchaseReturnSchema } from '@seed/schemas';
...
export default function PurchaseReturnForm() {
  ...
  const createMutation = clientTrpc.returns.createPurchaseReturn.useMutation({
    onSuccess: () => {
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Linked GRN (optional)</FormLabel>
                  <FormControl>
                    <Input
                      placeholder="GRN ID (optional)"
                      {...field}
                      value={field.value || ''}
                    />
                  </FormControl>
